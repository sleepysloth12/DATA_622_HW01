...
The application of machine learning algorithms for diabetes prediction has been extensively studied, including comparison between SVM and Decision Trees. Recent research demonstrates varying levels of effectiveness between these approaches.
...
The recent studies comparing machine learning algorithms for diabetes prediction highlight distinct strengths and trade-offs between SVM and decision trees. While decision trees often excel in interpretability and accuracy, as shown by Faruque et al. (2019), SVM demonstrates robust performance in handling high-dimensional and non-linear data, as emphasized in the findings of Ismail and Materwala (2020) and Sonawane et al. (2023).
